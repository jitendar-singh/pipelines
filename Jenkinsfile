         ...
         node("maven") {
          openshift.withCluster() {
            openshift.withProject() {
              ...
              echo "oc create secret generic my-private-ssh-key --from-file=ssh-privatekey=$HOME/.ssh/id_rsa --from-literal=username=jitendar"
              ...
              git branch: 'master', url: 'https://github.com/jitendar-singh/pipelines.git'
              echo "end"            
           }
          }
         }
